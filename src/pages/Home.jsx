...
const Home = () => {
  return (
    <>
      <div
        id="home"
        className="min-h-screen relative px-6 md:px-12 pt-32 pb-0 md:pb-20 overflow-hidden"
      >
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end min-h-[60vh] mb-20 md:mb-32 relative z-10">
          ...
          >
            <div className="flex flex-col gap-4">
              ...
              <p className="text-sm md:text-text text-subtext0 leading-relaxed font-light">
                Currently managing servers, databases, and system operations for
                Telkom Indonesia projects. Experienced in resolving complex
                cases and shell configuration.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-4 md:gap-8 text-xs md:text-sm font-bold uppercase tracking-widest text-overlay2">
              <MagneticButton>
                <a
                  ...
                  className="hover:text-text transition-colors block p-2"
                >
                  Github
                </a>
              </MagneticButton>
              <MagneticButton>
                <a
                  href="https://www.linkedin.com/in/nicholasalvis/"
                  className="hover:text-text transition-colors block p-2"
                >
                  LinkedIn
                </a>
