              ...
              <div className="flex justify-center mt-8">
                <div className="p-2 flex gap-4 rounded">
                  <a href="mailto:nicholasalvisaputra@gmail.com">
                    <svg
                      className="opacity-50 hover:opacity-100 transition-all hover:text-primary"
                  ...
                  <a href="https://github.com/kangnikol">
                    <svg
                      className="opacity-50 hover:opacity-100 transition-all hover:text-[#ffffff]"
