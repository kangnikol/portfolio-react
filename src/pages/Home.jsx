...
const Home = () => {
  return (
    <>
      <div id="home" className="min-h-screen relative px-6 md:px-12 pt-32 pb-20 overflow-hidden">
        {/* Giant Typography Hero */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end min-h-[60vh] mb-32 relative z-10">
          <m.div 
            ...
            className="flex-1"
          >
            <h1 className="text-[12vw] leading-[0.85] font-black tracking-tighter text-text mix-blend-difference select-none">
          ...
          >
            ...
            <div className="flex gap-8 text-sm font-bold uppercase tracking-widest text-overlay2">
